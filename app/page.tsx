    ...
    <div className="w-full h-full flex justify-center items-center relative bg-black">
      <div className="max-w-screen-xl w-full h-full flex relative">
        ...
        <section className="fixed w-[275px] flex flex-col items-stretch h-screen">
          ...
          <button className="rounded-full flex items-center space-x-2 m-4 bg-transparent p-4 text-center hover:bg-opacity-70 transition duration-200">
              
              <div className="rounded-full bg-slate-400 w-8 h-8">

              </div>
              <div className="text-left text-xs">
                <div className="font-semibold">Cameron</div>
                <div className="">@CameronW</div>
              </div>
              <div>
                <BsThreeDots/>
              </div>
